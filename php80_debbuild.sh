...
_build_deb(){
    ...
    cp -a /usr/lib/x86_64-linux-gnu/libzip.so.4.0.0 ${buildroot}${php80_location}/lib
    ...
    cp -a /usr/lib/x86_64-linux-gnu/libonig.so.4 ${buildroot}${php80_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libonig.so.4.0.0 ${buildroot}${php80_location}/lib
