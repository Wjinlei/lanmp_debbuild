...
_build_deb(){
    ...
    # Fix libtidy
    cp -a /usr/lib/libtidy-0.99.so.0 ${buildroot}${php80_location}/lib
    cp -a /usr/lib/libtidy-0.99.so.0.0.0 ${buildroot}${php80_location}/lib
    cp -a /usr/lib/libtidy.a ${buildroot}${php80_location}/lib
    cp -a /usr/lib/libtidy.so ${buildroot}${php80_location}/lib
    cp -a /usr/lib/libtidy.la ${buildroot}${php80_location}/lib
    # Fix libreadline
    cp -a /usr/lib/x86_64-linux-gnu/libreadline.a ${buildroot}${php80_location}/lib
    cp -a /lib/x86_64-linux-gnu/libreadline.so.6 ${buildroot}${php80_location}/lib
    cp -a /lib/x86_64-linux-gnu/libreadline.so.6.3 ${buildroot}${php80_location}/lib
    ln -s libreadline.so.6 libreadline.so
    # Fix libvpx
    cp -a /usr/lib/x86_64-linux-gnu/libvpx.so.1 ${buildroot}${php80_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libvpx.so.1.3.0 ${buildroot}${php80_location}/lib
    ...
    cp -a /usr/lib/x86_64-linux-gnu/libjpeg.so.62.1.0 ${buildroot}${php80_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libjpeg.so.62 ${buildroot}${php80_location}/lib
    # Fix libwebp
    cp -a /usr/lib/x86_64-linux-gnu/libwebpdemux.so.1.0.1 ${buildroot}${php80_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libwebp.so.5 ${buildroot}${php80_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libwebp.so ${buildroot}${php80_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libwebpmux.so ${buildroot}${php80_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libwebp.a ${buildroot}${php80_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libwebpmux.so.1 ${buildroot}${php80_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libwebp.so.5.0.1 ${buildroot}${php80_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libwebpdemux.so.1 ${buildroot}${php80_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libwebpmux.so.1.0.1 ${buildroot}${php80_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libwebpmux.a ${buildroot}${php80_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libwebpdemux.so ${buildroot}${php80_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libwebpdemux.a ${buildroot}${php80_location}/lib
