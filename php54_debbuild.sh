...
_build_deb(){
    ...
    # Fix libtidy
    cp -a /usr/lib/libtidys.a ${buildroot}${php54_location}/lib
    cp -a /usr/lib/libtidy.so.5 ${buildroot}${php54_location}/lib
    cp -a /usr/lib/libtidy.so.5.2.0 ${buildroot}${php54_location}/lib
    cp -a /usr/lib/libtidy.so ${buildroot}${php54_location}/lib
    # Fix libreadline
    ln -s libreadline.so.7 libreadline.so ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libreadline.a ${buildroot}${php54_location}/lib
    cp -a /lib/x86_64-linux-gnu/libreadline.so.7 ${buildroot}${php54_location}/lib
    cp -a /lib/x86_64-linux-gnu/libreadline.so.7.0 ${buildroot}${php54_location}/lib
    # Fix libvpx
    cp -a /usr/lib/x86_64-linux-gnu/libvpx.so ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libvpx.so.5.0.0 ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libvpx.so.5.0 ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libvpx.so.5 ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libvpx.a ${buildroot}${php54_location}/lib
    # Fix libtinfo
    ln -s libtinfo.so.5 libtinfo.so ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libtinfo.a ${buildroot}${php54_location}/lib
    cp -a /lib/x86_64-linux-gnu/libtinfo.so.5.9 ${buildroot}${php54_location}/lib
    cp -a /lib/x86_64-linux-gnu/libtinfo.so.5 ${buildroot}${php54_location}/lib
