...
_build_deb(){
    ...
    # Copy files
    cp -a --parents ${php54_location} ${buildroot}
    cp -a --parents /etc/init.d/php54 ${buildroot}
    mkdir -p ${buildroot}/etc/ld.so.conf.d
    mkdir -p ${buildroot}${php54_location}/lib
    cd ${buildroot}${php54_location}/lib
    # Fix libtidy
    cp -a /usr/lib/libtidy-0.99.so.0 ${buildroot}${php54_location}/lib
    cp -a /usr/lib/libtidy-0.99.so.0.0.0 ${buildroot}${php54_location}/lib
    cp -a /usr/lib/libtidy.a ${buildroot}${php54_location}/lib
    cp -a /usr/lib/libtidy.so ${buildroot}${php54_location}/lib
    cp -a /usr/lib/libtidy.la ${buildroot}${php54_location}/lib
    # Fix libreadline
    cp -a /usr/lib/x86_64-linux-gnu/libreadline.a ${buildroot}${php54_location}/lib
    cp -a /lib/x86_64-linux-gnu/libreadline.so.6 ${buildroot}${php54_location}/lib
    cp -a /lib/x86_64-linux-gnu/libreadline.so.6.3 ${buildroot}${php54_location}/lib
    ln -s libreadline.so.6 libreadline.so
    # Fix libvpx
    cp -a /usr/lib/x86_64-linux-gnu/libvpx.so.1 ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libvpx.so.1.3.0 ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libvpx.so ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libvpx.so.1.3 ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libvpx.a ${buildroot}${php54_location}/lib
    # Fix libtinfo
    libtinfo5_filename="libtinfo5"
    DownloadUrl ${libtinfo5_filename}.tar.gz http://test.hws.com/wangjinlei/${libtinfo5_filename}.tar.gz
    tar -xf ${libtinfo5_filename}.tar.gz -C  ${buildroot}${php54_location}/lib
    # Fix libzip
    cp -a /usr/lib/x86_64-linux-gnu/libzip.a ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libzip.so.2.1.0 ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libzip.so ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libzip.so.2 ${buildroot}${php54_location}/lib
    # Fix libz
    #cp -a /lib/x86_64-linux-gnu/libz.so.1.2.8 ${buildroot}${php54_location}/lib
    #cp -a /usr/lib/x86_64-linux-gnu/libz.a ${buildroot}${php54_location}/lib
    #ln -s libz.so.1.2.8 libz.so.1
    #ln -s libz.so.1 libz.so
    # Fix libonig
    cp -a /usr/lib/x86_64-linux-gnu/libonig.so.2.0.1 ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libonig.so ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libonig.so.2 ${buildroot}${php54_location}/lib
    # Fix libpng
    cp -a /usr/lib/x86_64-linux-gnu/libpng12.a ${buildroot}${php54_location}/lib
    cp -a /lib/x86_64-linux-gnu/libpng12.so.0.50.0 ${buildroot}${php54_location}/lib
    ln -s libpng12.so.0.50.0 libpng12.so.0
    ln -s libpng12.so.0 libpng12.so
    ln -s libpng12.so libpng.so
    ln -s libpng12.a libpng.a
    # Fix libjpeg
    cp -a /usr/lib/x86_64-linux-gnu/libjpeg.a ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libjpeg.so ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libjpeg.so.62.1.0 ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libjpeg.so.62 ${buildroot}${php54_location}/lib
    # Fix libwebp
    cp -a /usr/lib/x86_64-linux-gnu/libwebpdemux.so.1.0.1 ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libwebp.so.5 ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libwebp.so ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libwebpmux.so ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libwebp.a ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libwebpmux.so.1 ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libwebp.so.5.0.1 ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libwebpdemux.so.1 ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libwebpmux.so.1.0.1 ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libwebpmux.a ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libwebpdemux.so ${buildroot}${php54_location}/lib
    cp -a /usr/lib/x86_64-linux-gnu/libwebpdemux.a ${buildroot}${php54_location}/lib
    echo "${php54_location}/lib" > ${buildroot}/etc/ld.so.conf.d/php54.conf
...
Description: php5.4.45 build by hws
...
update-rc.d -f php54 defaults >/dev/null 2>&1
[ $? -ne 0 ] && echo "[ERROR]: update-rc.d -f php54 defaults"
/etc/init.d/php54 start
exit 0
EOF
...
update-rc.d -f php54 remove >/dev/null 2>&1
exit 0
EOF
...
EOF
    ...
    cd /tmp
    dpkg-deb -b ${buildroot} php-5.4.45-linux-amd64.deb
}
